...
export function LoginScreen({ city, onBack }: LoginScreenProps) {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-brand-primary/15 via-surface to-brand-secondary/15 px-4 py-5 text-text md:px-8 md:py-8">
              ...
              <form className="mt-8 space-y-4" onSubmit={(event) => event.preventDefault()}>
                ...
                <div className="flex items-center justify-between gap-3 pt-1 text-sm">
                  <label className="inline-flex items-center gap-2 text-text/80">
                    <input type="checkbox" className="h-4 w-4 rounded border-brand-primary/30 bg-transparent" />
                    Lembrar de mim
                  </label>
